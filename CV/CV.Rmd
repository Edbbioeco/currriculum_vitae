...
tibble::tibble(Evento = c(rep("Semana Nacional da Ciência e Tecnologia", 2),
               ...
               Ação = c(rep("Exposição: biodiversidade de anfíbios e répteis", 2),
                        ...
                        "Pôster: Diversidade Taxonômica e Filogenética de Anfíbios Anuros do Centro de Endemismo Pernambuco",
...
```{r, echo=FALSE, out.width="100%", fig.cap="Classificação de paisagens através de modelos de Machine Learning por Random Forest"}
knitr::include_graphics("uso_cobertura_solo.png")
```

\vspace{10pt}

```{r, echo=FALSE, out.width="100%", fig.cap="Modelo de distribuição de espécies para o Nordeste BraBrasileiro."}
knitr::include_graphics("cocorobensis_modelo.png")
```

\vspace{10pt}

```{r, echo=FALSE, out.width="100%", fig.cap="Visualização de vocalização de espécies por espectrograma e oscilograma."}
knitr::include_graphics("gg_espectro_oscilo.png")
